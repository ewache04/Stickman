...
Discription:
Using GUI to Create a program in Python that displays a stick man
...
class StickMan(object):
    ...
    def large_stickman(self):
        ...
        #if large_button.clicked(self.mouse_point):            
    ...
    def medium_stickman(self):
        ...
        #if medium_button.clicked(self.mouse_point):         
    ...
    def small_stickman(self):
        ...
        #if small_button.clicked(self.mouse_point):  
    ...
    def color_stickman_method(self):
        ...
        self.head.setFill(random.choice([self.color_list[2],self.color_list[3],self.color_list[4]]))#Color choise(red,blue, and green)
        
        self.right_eye.setFill(self.color_list[0])#Black color
        self.right_eye_color.setFill(self.color_list[7])#white color
        
        self.left_eye.setFill(self.color_list[0])#Black color
        self.left_eye_color.setFill(self.color_list[7])#white color
        
        self.nose.setFill(self.color_list[0])# white color
        self.mouth.setFill(self.color_list[0])#Black color        
        self.neck.setFill(self.color_list[0])#Black color
        self.sholder.setFill(self.color_list[6])#Gray color
        self.T_shirt.setFill(self.color_list[5])#Brown color        
        
        self.right_arm.setFill(self.color_list[0])#Black color
        self.left_arm.setFill(self.color_list[0])#Black color
        
        self.right_pants.setFill(self.color_list[6])#Gray color
        self.right_leg.setFill(self.color_list[0])#Black color
        
        self.left_pants.setFill(self.color_list[6])#Gray color
        self.left_leg.setFill(self.color_list[0])#Black color
...
stickman_instanciator = StickMan(name,color_list)#objects
